...
<section class="content">
        ...
        <div class="letters-rule-system">
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-7">
                            <?php if( $post_type == 'studio' ): $json_file_path = "studi-list.json";
                            //$curl_url = "https://crm.newsmemory.com:8143/api/toplegal/contacts?type[]=societa&type[]=".$post_type; ?>
                            ...
                            <?php elseif ( $post_type == 'professionista' ): $json_file_path = "professionisti-list.json";
                            //$curl_url = "https://crm.newsmemory.com:8143/api/toplegal/contacts?type[]=".$post_type; ?>
    ...
    <div class="container">
        ...
        curl_close($ch);*/
        /*---------------------------------------------------------------------------------------*/
            $string = file_get_contents($_SERVER['DOCUMENT_ROOT']."/toplegal/wp-content/uploads/".$json_file_path, true);
